...
public partial class PoeDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Server=tcp:garthdp.database.windows.net,1433;Initial Catalog=garthdppoe;Persist Security Info=False;User ID=garthdp;Password=Siteharm37;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
    }
